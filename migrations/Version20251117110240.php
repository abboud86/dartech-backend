 ...
 */
final class Version20251117110240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE audit_log (id UUID NOT NULL, actor_type VARCHAR(32) NOT NULL, actor_id VARCHAR(64) NOT NULL, target_type VARCHAR(32) NOT NULL, target_id VARCHAR(64) NOT NULL, action VARCHAR(64) NOT NULL, data_before JSON DEFAULT NULL, data_after JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_audit_actor ON audit_log (actor_type, actor_id)');
        $this->addSql('COMMENT ON COLUMN audit_log.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN audit_log.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE booking (id UUID NOT NULL, client_id UUID NOT NULL, artisan_service_id UUID NOT NULL, status_marking VARCHAR(50) DEFAULT NULL, communication_channel VARCHAR(50) DEFAULT NULL, scheduled_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, estimated_amount NUMERIC(12, 2) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E00CEDDE19EB6921 ON booking (client_id)');
        $this->addSql('CREATE INDEX IDX_E00CEDDE8189807B ON booking (artisan_service_id)');
        $this->addSql('COMMENT ON COLUMN booking.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN booking.client_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN booking.artisan_service_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN booking.scheduled_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDE19EB6921 FOREIGN KEY (client_id) REFERENCES "user" (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE booking ADD CONSTRAINT FK_E00CEDDE8189807B FOREIGN KEY (artisan_service_id) REFERENCES artisan_service (id) ON DELETE RESTRICT NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking DROP CONSTRAINT FK_E00CEDDE8189807B');
